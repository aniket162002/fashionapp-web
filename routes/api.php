...
Route::group(['prefix' => 'v2/auth', 'middleware' => ['app_language']], function () {
    ...
    Route::post('password/phone_reset', [PasswordResetController::class, 'phonePasswordReset']);
...
Route::group(['prefix' => 'v2', 'middleware' => ['app_language']], function () {
    ...
    Route::get('google-places/details', [\App\Http\Controllers\Api\V2\GooglePlacesController::class, 'getPlaceDetails']);
