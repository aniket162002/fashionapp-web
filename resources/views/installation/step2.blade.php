                  ...
                  <!-- Top content -->
                    <div class="mar-ver pad-btm text-center">
                        ...
                        <p class="fs-12 fw-500" style="color:  #666; line-height: 18px;">
                            ...
                            <br>
                            <a href="https://babia.to/members/sagar7906.80606/" target="_blank" style="font-weight:bold;color:#000;"><i>Nulled By @sagar7906</i></a>
                            <br>
                            <a href="https://babia.to" target="_blank" style="font-weight:bold;color:#000;"><i>Join Babiato Best Place for everyone</i></a>
                        </p>
                    </div>
                    ...
                    <form method="POST" action="{{ route('purchase.code') }}">
                        ...
                        <div class="form-group mb-3">
                            ...
                            <input type="text" class="form-control rounded-2 border" style="height: 36px !important;" id="purchase_code" name="purchase_code" placeholder="Enter Anything" required>
                        </div>
                        <div class="form-group">
                            <label for="system_key" class="fs-12 fw-500" style="color: #666;">System Key</label>
                            <input type="text" class="form-control rounded-2 border" style="height: 36px !important;" id="system_key" name="system_key" placeholder="Enter Anything" required>
