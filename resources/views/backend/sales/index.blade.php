                ...
                <table class="table aiz-table mb-0">
                    <thead>
                        <tr>
                            ...
                            <th data-breakpoints="md">{{ translate('Order Image') }}</th>
                        ...
                        @foreach ($orders as $key => $order)
                            <tr>
                                ...
                                <td>
                                    ...
                                    @endphp
                                    @if($firstDetail && $firstDetail->product && $firstDetail->product->thumbnail_img)
                                        <div class="d-flex align-items-center">
                                            <img src="{{ uploaded_asset($firstDetail->product->thumbnail_img) }}" 
                                                 alt="{{ $firstDetail->product->getTranslation('name') }}" 
                                                 class="img-thumbnail" 
                                                 style="width: 50px; height: 50px; object-fit: cover;">
                                            @if($totalProducts > 1)
                                                <span class="badge badge-secondary ml-2">+{{ $totalProducts - 1 }}</span>
                                            @endif
                                        </div>
                                    @else
                                        <div class="d-flex align-items-center justify-content-center" style="width: 50px; height: 50px; background-color: #f8f9fa; border: 1px solid #dee2e6; border-radius: 4px;">
                                            <i class="las la-image text-muted" style="font-size: 20px;"></i>
                                        </div>
                                    @endif
                                </td>
                                <td>
